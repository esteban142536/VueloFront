...
export class HistoriaComponent implements OnInit {
  ...
  longText =  
      ...
      luego de un sin número de experiencias en ventas de tiquetes de avión y la necesidad de ser un 
      ...
      Con las experiencias adquiridas, se empezo a conformar los propios planes de vuelos, creando un gran 
